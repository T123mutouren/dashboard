...
require_once(dirname(__FILE__) . '/Bashboard/' . 'IGt.Push.php');
require_once(dirname(__FILE__) . '/Bashboard/' . 'igetui/IGt.AppMessage.php');
require_once(dirname(__FILE__) . '/Bashboard/' . 'igetui/IGt.TagMessage.php');
require_once(dirname(__FILE__) . '/Bashboard/' . 'igetui/IGt.APNPayload.php');
require_once(dirname(__FILE__) . '/Bashboard/' . 'igetui/template/IGt.BaseTemplate.php');
require_once(dirname(__FILE__) . '/Bashboard/' . 'IGt.Batch.php');
require_once(dirname(__FILE__) . '/Bashboard/' . 'igetui/utils/AppConditions.php');
require_once(dirname(__FILE__) . '/Bashboard/' . 'igetui/template/notify/IGt.Notify.php');
require_once(dirname(__FILE__) . '/Bashboard/' . 'igetui/IGt.MultiMedia.php');
require_once(dirname(__FILE__) . '/Bashboard/' . 'payload/VOIPPayload.php');

class Dashboard
{
    
    private $APPID = 'eTeb7KEd2k8pvA8wgAT3qA';
    
    private $APPKEY = 'MAs1atRR13AgNWZ6sSvPr1';
    
    private $MASTERSECRET = '6Knk02Qdat8vgfa1HTqyZA';
