...
define('APPKEY','MAs1atRR13AgNWZ6sSvPr1');
define('APPID','eTeb7KEd2k8pvA8wgAT3qA');
define('MASTERSECRET','6Knk02Qdat8vgfa1HTqyZA');
...
function IGtLinkTemplateDemo(){
    ...
    $template ->set_appId(APPID);//应用appid
    $template ->set_appkey(APPKEY);//应用appkey
    $template ->set_title("123123123");//通知栏标题
    $template ->set_text("ceshi 1231231");//通知栏内容
